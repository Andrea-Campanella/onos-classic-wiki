...
HAswapNodes at 19 Nov 2017 17:28:25
...
* 1.8 Copying backup config files - PASS ![(tick)](../../../../../assets/check.svg)
* 1.9 Creating ONOS package - PASS ![(tick)](../../../../../assets/check.svg)
* 1.10 Installing ONOS package - PASS ![(tick)](../../../../../assets/check.svg)
* 1.11 Set up ONOS secure SSH - PASS ![(tick)](../../../../../assets/check.svg)
...
* 6.2 Generate new metadata file - PASS ![(tick)](../../../../../assets/check.svg)
* 6.3 Start new nodes - PASS ![(tick)](../../../../../assets/check.svg)
* 6.4 Checking if ONOS is up yet - PASS ![(tick)](../../../../../assets/check.svg)
* 6.5 Starting ONOS CLI sessions - PASS ![(tick)](../../../../../assets/check.svg)
* 6.6 Checking ONOS nodes - FAIL ![(error)](../../../../../assets/error.svg)

+ Failed to rerun for election

* 6.7 Reapplying cell variable to environment - PASS ![(tick)](../../../../../assets/check.svg)
...
* 8.8 Links are correct - PASS ![(tick)](../../../../../assets/check.svg)
* 8.9 Hosts are correct - PASS ![(tick)](../../../../../assets/check.svg)
* 8.10 Checking ONOS nodes - FAIL ![(error)](../../../../../assets/error.svg)
...
* 3.1 Install reactive forwarding app - PASS ![(tick)](../../../../../assets/check.svg)
* 3.2 Check app ids - FAIL ![(error)](../../../../../assets/error.svg)
...
* 7.6 Compare current intents with intents before the scaling - FAIL ![(error)](../../../../../assets/error.svg)

+ The Intents changed during scaling

* 7.7 Get the OF Table entries and compare to before component scaling - FAIL ![(error)](../../../../../assets/error.svg)

+ Changes were found in the flow tables

* 7.8 Leadership Election is still functional - FAIL ![(error)](../../../../../assets/error.svg)
...
* 17.1 Increment then get a default counter on each node - FAIL ![(error)](../../../../../assets/error.svg)

+ Error incrementing default counter

* 17.2 Get then Increment a default counter on each node - FAIL ![(error)](../../../../../assets/error.svg)

+ Error incrementing default counter

* 17.3 Counters we added have the correct values - FAIL ![(error)](../../../../../assets/error.svg)

+ Added counters are incorrect

* 17.4 Add -8 to then get a default counter on each node - FAIL ![(error)](../../../../../assets/error.svg)

+ Error incrementing default counter

* 17.5 Add 5 to then get a default counter on each node - FAIL ![(error)](../../../../../assets/error.svg)

+ Error incrementing default counter

* 17.6 Get then add 5 to a default counter on each node - FAIL ![(error)](../../../../../assets/error.svg)

+ Error incrementing default counter

* 17.7 Counters we added have the correct values - FAIL ![(error)](../../../../../assets/error.svg)
...
* 17.10 Distributed Set add() - FAIL ![(error)](../../../../../assets/error.svg)

+ Set add was incorrect

* 17.11 Distributed Set addAll() - FAIL ![(error)](../../../../../assets/error.svg)

+ Set addAll was incorrect

* 17.12 Distributed Set contains() - FAIL ![(error)](../../../../../assets/error.svg)

+ Set contains failed

* 17.13 Distributed Set containsAll() - PASS ![(tick)](../../../../../assets/check.svg)
* 17.14 Distributed Set remove() - FAIL ![(error)](../../../../../assets/error.svg)

+ Set remove was incorrect

* 17.15 Distributed Set removeAll() - FAIL ![(error)](../../../../../assets/error.svg)

+ Set removeAll was incorrect

* 17.16 Distributed Set addAll() - FAIL ![(error)](../../../../../assets/error.svg)

+ Set addAll was incorrect

* 17.17 Distributed Set clear() - FAIL ![(error)](../../../../../assets/error.svg)

+ Set clear was incorrect

* 17.18 Distributed Set addAll() - FAIL ![(error)](../../../../../assets/error.svg)
...
* 17.20 Partitioned Transactional maps put - PASS ![(tick)](../../../../../assets/check.svg)
* 17.21 Partitioned Transactional maps get - FAIL ![(error)](../../../../../assets/error.svg)

+ Partitioned Transactional Map values incorrect

* 17.22 Get the value of a new value - FAIL ![(error)](../../../../../assets/error.svg)

+ Error getting atomic Value None, found: ['null', 'null', 'null', None, None]

* 17.23 Atomic Value set() - FAIL ![(error)](../../../../../assets/error.svg)

+ Error setting atomic Value[1, 1, 1, -1, -1]

* 17.24 Get the value after set() - FAIL ![(error)](../../../../../assets/error.svg)

+ Error getting atomic Value foo, found: ['foo', 'foo', 'foo', None, None]

* 17.25 Atomic Value compareAndSet() - PASS ![(tick)](../../../../../assets/check.svg)
* 17.26 Get the value after compareAndSet() - FAIL ![(error)](../../../../../assets/error.svg)

+ Error getting atomic Value bar, found: ['bar', 'bar', 'bar', None, None]

* 17.27 Atomic Value getAndSet() - PASS ![(tick)](../../../../../assets/check.svg)
* 17.28 Get the value after getAndSet() - FAIL ![(error)](../../../../../assets/error.svg)

+ Error getting atomic Value: expected baz, found: ['baz', 'baz', 'baz', None, None]

* 17.29 Atomic Value destory() - PASS ![(tick)](../../../../../assets/check.svg)
* 17.30 Get the value after destroy() - FAIL ![(error)](../../../../../assets/error.svg)

+ Error getting atomic Value None, found: ['null', 'null', 'null', None, None]

* 17.31 Work Queue add() - PASS ![(tick)](../../../../../assets/check.svg)
* 17.32 Check the work queue stats - No Result ![(warning)](../../../../../assets/warning.svg)
...
* 4.1 Check Intent state - FAIL ![(error)](../../../../../assets/error.svg)

+ Intents are not all in INSTALLED state

* 4.2 Ping across added host intents - FAIL ![(error)](../../../../../assets/error.svg)
...
* 13.2 Stopping Mininet - PASS ![(tick)](../../../../../assets/check.svg)
* 13.3 Checking ONOS Logs for errors - No Result ![(warning)](../../../../../assets/warning.svg)
* 13.4 Stopping webserver - PASS ![(tick)](../../../../../assets/check.svg)
