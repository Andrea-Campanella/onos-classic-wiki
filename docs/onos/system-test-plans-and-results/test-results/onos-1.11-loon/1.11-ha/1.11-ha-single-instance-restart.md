# 1.11-HA Single Instance Restart

HAsingleInstanceRestart at 08 Apr 2018 21:11:04![HAsingleInstanceRestart](https://jenkins.onosproject.org/view/QA/job/postjob-VM/lastSuccessfulBuild/artifact/HAsingleInstanceRestart_onos-1.11_20-builds_graph.jpg)
...
* 1.13 Set ONOS configurations - FAIL ![(error)](../../../../../assets/error.svg)

+ Failed to set config

* 1.14 Check app ids - PASS ![(tick)](../../../../../assets/check.svg)
* 1.15 Set logging levels - PASS ![(tick)](../../../../../assets/check.svg)
