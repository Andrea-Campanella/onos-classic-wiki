# 1.15-HA Upgrade Rollback

HAupgradeRollback at 17 Feb 2019 10:46:14![HAupgradeRollback](https://jenkins.onosproject.org/view/QA/job/postjob-VM/lastSuccessfulBuild/artifact/HAupgradeRollback_onos-1.15_20-builds_graph.jpg)
...
* 63.1 Rollbak the upgrade - PASS ![(tick)](../../../../../assets/check.svg)
* 63.2 Check the status of the upgrade - No Result ![(warning)](../../../../../assets/warning.svg)
...
* 64.1 Send the command to reset the upgrade - FAIL ![(error)](../../../../../assets/error.svg)

+ Error committing the upgrade

* 64.2 Check the status of the upgrade - No Result ![(warning)](../../../../../assets/warning.svg)
