...
HATestSanity at 29 Jun 2015 13:43:19
...
* 1.3 Git checkout and pull onos-1.2 - PASS ![(tick)](../../../../../assets/check.svg)
...
* 8.4 Hosts view is consistent across all ONOS nodes - PASS ![(tick)](../../../../../assets/check.svg)
* 8.5 Hosts information is correct - PASS ![(tick)](../../../../../assets/check.svg)
* 8.6 Host attachment points to the network - PASS ![(tick)](../../../../../assets/check.svg)
* 8.7 Clusters view is consistent across all ONOS nodes - PASS ![(tick)](../../../../../assets/check.svg)
* 8.8 There is only one SCC - PASS ![(tick)](../../../../../assets/check.svg)
* 8.9 Device information is correct - PASS ![(tick)](../../../../../assets/check.svg)
* 8.10 Port information is correct - PASS ![(tick)](../../../../../assets/check.svg)
* 8.11 Links are correct - PASS ![(tick)](../../../../../assets/check.svg)
* 8.12 Checking ONOS nodes - PASS ![(tick)](../../../../../assets/check.svg)
...
* 5.10 Create TestONTopology object - No Result ![(warning)](../../../../../assets/warning.svg)
...
* 7.4 Compare switch roles from before failure - PASS ![(tick)](../../../../../assets/check.svg)
* 7.5 Get the intents and compare across all nodes - PASS ![(tick)](../../../../../assets/check.svg)
* 7.6 Check for consistency in Intents from each controller - PASS ![(tick)](../../../../../assets/check.svg)
* 7.7 Compare current intents with intents before the failure - PASS ![(tick)](../../../../../assets/check.svg)
* 7.8 Get the OF Table entries and compare to before component failure - PASS ![(tick)](../../../../../assets/check.svg)
* 7.9 Check the continuous pings to ensure that no packets were dropped during component failure - PASS ![(tick)](../../../../../assets/check.svg)
* 7.10 Leadership Election is still functional - PASS ![(tick)](../../../../../assets/check.svg)
...
* 15.1 Check that each node shows the same leader - PASS ![(tick)](../../../../../assets/check.svg)
* 15.2 Find current leader and withdraw - PASS ![(tick)](../../../../../assets/check.svg)
* 15.3 Make sure new leader is elected - PASS ![(tick)](../../../../../assets/check.svg)
* 15.4 Run for election on old leader( just so everyone is in the hat ) - PASS ![(tick)](../../../../../assets/check.svg)
* 15.5 Leader did not change when old leader re-ran - PASS ![(tick)](../../../../../assets/check.svg)
