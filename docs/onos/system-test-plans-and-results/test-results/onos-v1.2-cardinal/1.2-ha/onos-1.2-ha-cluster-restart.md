# onos-1.2-HA Cluster Restart

HATestClusterRestart at 30 Jun 2015 03:01:49
...
* 6.1 Killing ONOS nodes - PASS ![(tick)](../../../../../assets/check.svg)
...
* 8.4 Hosts view is consistent across all ONOS nodes - PASS ![(tick)](../../../../../assets/check.svg)
* 8.5 Hosts information is correct - PASS ![(tick)](../../../../../assets/check.svg)
* 8.6 Host attachment points to the network - FAIL ![(error)](../../../../../assets/error.svg)
...
* 3.1 Install reactive forwarding app - PASS ![(tick)](../../../../../assets/check.svg)
* 3.2 Check app ids - PASS ![(tick)](../../../../../assets/check.svg)
* 3.3 Discovering Hosts( Via pingall for now ) - FAIL ![(error)](../../../../../assets/error.svg)
...
* 7.6 Get the OF Table entries and compare to before component failure - FAIL ![(error)](../../../../../assets/error.svg)

+ Changes were found in the flow tables

* 7.7 Leadership Election is still functional - PASS ![(tick)](../../../../../assets/check.svg)
...
* 15.2 Check that each node shows the same leader - PASS ![(tick)](../../../../../assets/check.svg)
* 15.3 Find current leader and withdraw - PASS ![(tick)](../../../../../assets/check.svg)
* 15.4 Make sure new leader is elected - PASS ![(tick)](../../../../../assets/check.svg)
* 15.5 Run for election on old leader( just so everyone is in the hat ) - PASS ![(tick)](../../../../../assets/check.svg)
* 15.6 Leader did not change when old leader re-ran - PASS ![(tick)](../../../../../assets/check.svg)
...
### Case 12: Adding a switch to ensure it is discovered correctly - FAIL

* 12.1 Add back s5 - FAIL ![(error)](../../../../../assets/error.svg)
