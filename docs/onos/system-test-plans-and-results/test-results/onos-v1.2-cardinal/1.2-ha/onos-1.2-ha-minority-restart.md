...
* 6.1 Killing 3 ONOS nodes - PASS ![(tick)](../../../../../assets/check.svg)
* 6.2 Checking if ONOS is up yet - PASS ![(tick)](../../../../../assets/check.svg)
* 6.3 Restarting ONOS CLIs - PASS ![(tick)](../../../../../assets/check.svg)
...
* 7.6 Compare current intents with intents before the failure - PASS ![(tick)](../../../../../assets/check.svg)
* 7.7 Get the OF Table entries and compare to before component failure - PASS ![(tick)](../../../../../assets/check.svg)
* 7.8 Check the continuous pings to ensure that no packets were dropped during component failure - PASS ![(tick)](../../../../../assets/check.svg)
* 7.9 Leadership Election is still functional - PASS ![(tick)](../../../../../assets/check.svg)
