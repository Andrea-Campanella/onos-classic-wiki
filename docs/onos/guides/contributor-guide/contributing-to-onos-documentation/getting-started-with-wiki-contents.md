...
Standardise and speed up the page creation process with templates. You can create and format a template with page layouts, standard headings and instructional text for hints and guidelines. Check out our sample page on "[Making a template](getting-started-with-wiki-contents/making-a-template.md)"

**Related pages**

* Page:

  [Doc Template with Modified Date/User](../../../../onos-system-test/wiki-documentation-tools/doc-template-with-modified-dateuser.md)
* Page:

  [Getting Started](../../../../onos-system-test/getting-started.md)
* Page:

  [Getting Started with Wiki Contents](getting-started-with-wiki-contents.md)
* Page:

  [Making a template](getting-started-with-wiki-contents/making-a-template.md)
